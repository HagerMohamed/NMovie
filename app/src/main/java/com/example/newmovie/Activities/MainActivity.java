...
public class MainActivity extends AppCompatActivity implements Change{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       setContentView(R.layout.activity_main);
        ...
        if (savedInstanceState == null){
            ...
            mainActivityFragment.selectMovie(this);
            getSupportFragmentManager().beginTransaction().replace(R.id.frame, mainActivityFragment)
                    .commit();
    ...
    public void changeFragment (Movie m){
        ...
        if (tablet ){
            ...
            Bundle bundle = new Bundle();
            bundle.putSerializable("movie", m);
            Intent intent = new Intent(this , SecondActivityFragment.class);
